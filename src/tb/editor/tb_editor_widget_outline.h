...
#include "tb_msg.h"
#include "editor/tb_editor_widget_base.h"
...
namespace tb {
	...
	class TBEditorWidgetOutline :
			public TBWidget,
			public TBEditorWidgetBase<TBWidget>,
			public TBMessageHandler,
			public TBWidgetListener {
		TBOBJECT_SUBCLASS(TBEditorWidgetOutline, TBWidget);
